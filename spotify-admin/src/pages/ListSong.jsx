...
const ListSong = () => {
  ...
  return (
    <div>
      <p className="font-bold text-lg mb-4">All Songs List</p>
      <br />
      <div>
        ...
        {data.map((item, index) => {
          return (
            <div key={index} className='grid grid-cols-[1fr_1fr_1fr] sm:grid-cols-[0.5fr_1fr_2fr_1fr_0.5fr] items-center gap-2.5 p-3 border boder-gray-300 text-sm mr-5'> 
